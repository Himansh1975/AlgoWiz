...
const Home = () => {
  return (
    <div className="h-screen flex flex-col items-center justify-center bg-gradient-to-r from-purple-500 to-indigo-600 text-white p-6">
      <h1 className="text-5xl font-bold mb-6">Welcome to the Algorithm Visualizer</h1>
      <p className="text-lg mb-10 text-center max-w-2xl">Explore different algorithm visualizations to better understand how they work. Use the control buttons to start, stop, reset, and shuffle the visualizations.</p>
